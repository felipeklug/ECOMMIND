...
const mockData = {
  ...
  recentOrders: [
    { id: '#1234', customer: 'João Silva', value: 299.90, status: 'confirmed', channel: 'ML' },
    { id: '#1235', customer: 'Maria Santos', value: 159.90, status: 'pending', channel: 'Shopee' },
    { id: '#1236', customer: 'Carlos Oliveira', value: 89.90, status: 'shipped', channel: 'Site' }
  ]
}
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '14px', color: '#9CA3AF', margin: 0 }}>Dashboard Demo</p>
            </div>
          </div>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
                  <div>
                    ...
                    <p style={{ fontSize: '14px', color: '#9CA3AF', margin: 0 }}>
                      Produto com estoque para apenas 3 dias no Mercado Livre (5 unidades)
                    </p>
                  </div>
                  <button style={{
                    padding: '6px 12px',
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <div style={{
              ...
              <CheckCircle style={{ width: '24px', height: '24px', color: '#A78BFA' }} />
            </div>
            <div>
              <h3 style={{ fontSize: '18px', fontWeight: '600', margin: '0 0 4px' }}>
                🎉 Parabéns! Você está no ECOMMIND
              </h3>
              <p style={{ color: '#9CA3AF', margin: 0 }}>
                Esta é uma versão de demonstração com dados simulados. 
                A estrutura completa de BI, alertas e cálculos de margem já está implementada e funcionando!
              </p>
            </div>
          </div>
        </div>
